...
load(paste0("../data/working/", gene, "_7_chimera.RData"))
...
seqtab_nochim_tall <- as_tibble(seqtab_nochim, rownames = "sample") %>%
  pivot_longer(
    !sample,
    names_to = "ASV",
    values_to = "count"
...
# Also create a new column in this table that contains "sample", "feature", and
