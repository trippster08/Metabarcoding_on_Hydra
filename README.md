...
We currently have common metabarcoding primer sets for multiple gene regions. To get a list of the current available primer sets, run the following code in the termninal:
```
